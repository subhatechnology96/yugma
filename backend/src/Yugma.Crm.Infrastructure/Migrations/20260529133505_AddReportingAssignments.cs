...
{
    /// <inheritdoc />
    public partial class AddReportingAssignments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "reporting_assignments",
                schema: "yugma",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_reporting_assignments", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_reporting_assignments_TenantId_EmployeeId_EffectiveFrom",
                schema: "yugma",
                table: "reporting_assignments",
